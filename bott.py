...
@router.message(lambda message: message.text == "Распи-сание группы")
...
@router.message(lambda message: message.text == "Распи-сание преподавателя")
...
@router.message(lambda message: message.text == "Распи-сание звонков")
...
async def info_submenu_handler(message: Message):
    if message.text == "Личный кабинет":
        ...
        await message.answer("Информация об учебном про-цессе: https://knastu.ru/page/1404")
    await message.answer("Выберите, что вас интересует:", reply_markup=info_keyboard)

#Хэндлер кнопок "Ресурсы"
@router.message(lambda message: message.text in ["Биб-лиотека", "Электронные образовательные ресурсы", "Интер-нет-ресурсы", "Методические материалы", "Календарные учебные графики"])
async def resources_submenu_handler(message: Message):
    if message.text == "Библиотека":
        ...
        await message.answer("Ссылка на электронные об-разовательные ресурсы: https://knastu.ru/students/e_resources")
        ...
        await message.answer("Ссылка на методические ма-териалы: https://knastu.ru/page/1714")
    elif message.text == "Календарные учебные графики":
        await message.answer("Информация об учебных гра-фиках: https://knastu.ru/page/3602")
    await message.answer("Выберите, что вас интересует:", reply_markup=resources_keyboard)
